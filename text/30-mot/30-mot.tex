...
\begin{figure}
    ...
    \caption{
        %Two-dimensional schematic of creation of restoring forces: Due to position-dependent detuning of beams of different helicity... Due to the magnetic gradient and the Zeeman effect, on each side of the trap, different transitions between magnetic sublevels are on resonance. Assigning different helicity of circular polarization to counter-propagating lasers, atoms sense a scattering force towards the trap center for any displacement.
    \todo[inline]{shorter, more concise, more saying what the picture means}
