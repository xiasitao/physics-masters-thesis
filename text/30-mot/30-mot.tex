...
\begin{figure}
    \centering
<<<<<<< HEAD
    \caption{Photograph of the part of the optics setup providing light for the 2-dimensional magneto-optical trap. The beam path and reference points from figure~\ref{fig:laser_setup_schematic} have been added for orientation. [[Add more reference points]]}\label{fig:2d_mot_setup_photo}
=======
...
>>>>>>> 2d8cb500f89582a38026f37a70cd41723f1fd5eb
\end{figure}
...
The slimmed-down light is then coupled through the first acousto-optical modulator.