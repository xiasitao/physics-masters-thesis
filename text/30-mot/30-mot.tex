...
\end{align}
As visualised in figure \ref{fig:light_scattering_moment_transfer}, the atoms are decelerated opposite the direction of laser propagation, corresponding to cooling of the atoms.
