...
\begin{figure}
    \caption{Schematic of the experimental setup for finding the right configuration of the wave plates on the reflection stages:}\label{fig:second_pass_waveplate_adjustment_scheme}
\end{figure}
