...
\todo{unify Helmholtz/Feshbach terminology}
...
\todo{mention resistance and resonance measurement}
...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        ...
        \caption{Expected field gradient for different coil positions}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        ...
        \caption{Expected trap frequency for different coil positions}
        \label{fig:position_optimization_trapfrequency}
    \end{subfigure}
    \caption{Optimization of the coil positions with respect to gradient and trap frequency: Using the fit parameters of the single coil measurements for \textit{Gauss} and \textit{Tesla} (see figure~\ref{fig:single_coil_fields} and table~\ref{tab:single_coil_fields_fit_parameters}), the field landscape was sampled from the model \eqref{eq:on_axis_field_model} for different coil positions. Optimal positions are listed in table~\ref{tab:position_optimization_results}.}
...
\begin{table}
    ...
    \begin{tabular}{rccc}
        ...
        \bottomrule
    \end{tabular}
    \caption{Optimal positions of the coils \textit{Gauss} and \textit{Tesla} as concluded from the grid-search optimization }
