...
Using a Sensys FGM3D/1000 magnetic field probe, the on-axis magnetic field produced by the three coils \textit{Gauss}, \textit{Maxwell}, and \textit{Tesla} was mapped and is displayed in figure~\ref{fig:single_coil_fields}. In addition to that, the fields were fit to the following model:

\begin{figure}
    \caption{Fields of a single coil: simulation results and measurements for \textit{Gauss}, \textit{Maxwell}, and \textit{Tesla}}
