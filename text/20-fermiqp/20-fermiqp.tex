...
Universal quantum computers need to implement two kinds of gate operations: single-qubit gates for flipping indivudial qubits and two-qubit gates for entangling two qubits~\cite{hidary_quantum_2021, mainzer_quantencomputer_2020}:\todo{more citations}
...
\begin{figure}
    ...
    \todo[inline]{remove stage, add objectives, add vaccum sections}
    }
    \label{fig:chamber}
\end{figure}
